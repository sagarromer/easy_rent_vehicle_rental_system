...
import { newVehicle, clearErrors } from '../../redux/actions/vehicleActions'
import { NEW_VEHICLE_RESET } from '../../redux/constants/vehicleConstants'
...
const NewVehicle = () => {
    ...
    useEffect(() => {
        ...
        if (success) {
            ...
            dispatch({ type: NEW_VEHICLE_RESET })
        }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(newVehicle(vehicleData))
            ...
            <div className="row wrapper">
                <div className="col-10 col-lg-8">
                    <form className="shadow-lg" onSubmit={submitHandler} enctype="multipart/form-data">
                        <h1 className="mb-4">New Vehicle</h1>
                        ...
                        <div className="form-group">
                            <label htmlFor="vehicleNumber_field">VehicleNumber</label>
                            <input
                                type="text"
