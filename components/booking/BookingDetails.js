        ...
        <div className="container">
            <div className="row d-flex justify-content-between">
                <div className="col-12 col-lg-8 mt-5 booking-details">
                    {booking && booking.vehicle && booking.user &&
                        <>
                            ...
                            <p><b>Check In:</b> {new Date(booking.startDate).toLocaleString('en-US')}</p>

                            <p><b>Check Out:</b> {new Date(booking.endDate).toLocaleString('en-US')}</p>
                            ...
                            <div className="cart-item my-1">
                                <div className="row my-5">
                                    ...
                                    <div className="col-5 col-lg-5">
                                        <Link href={`/vehicle/${booking.vehicle._id}`}>{booking.vehicle.name}</Link>
                                    </div>

                                    <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                                        <p>${booking.vehicle.pricePerDay}</p>
                                    </div>

                                    <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                                        <p>{booking.daysOfRent} Day(s)</p>
                                    </div>
                                </div>
                            </div>
                            <hr />
